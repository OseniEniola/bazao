package com.bezao.assessment;

import java.text.DecimalFormat;
public class TaskOne extends WordToNumber {
...
//calling the user-defined method that converts the parsed number into words
        ...
        System.out.println(convertNumberToWord(9000000));
         ...
         String input4 = "fourty million three hundred and seventy five thousand five hundred";
         String input5 = "fourty million three hundred and seventy five";
         wordToNumber(input1);
         wordToNumber(input2);
         wordToNumber(input3);
         wordToNumber(input4);
